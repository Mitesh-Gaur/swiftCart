  ...
  return (
    <div className="lg:w-full mx-auto flex flex-wrap bg-white p-8 rounded-[0.5rem] shadow mt-4">
      <div className="max-w-[26rem] pt-8">
        <Image
          className="mx-auto w-[26rem] h-[26rem] object-contain mb-[0.75rem] transform -rotate-[15deg]"
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          <span className="flex items-center">
            <svg fill="#cb202d" stroke="#cb202d" strokeLinecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 text-indigo-500" viewBox="0 0 24 24">
            ...
            <svg fill="none" stroke="#cb202d" strokeLinecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 text-indigo-500" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
            </svg>
